defmodule Rewards.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :role, RolesEnum, default: :member
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Rewards.Repo)
  ...
  """
  def valid_password?(%Rewards.Accounts.User{hashed_password: hashed_password}, password)
